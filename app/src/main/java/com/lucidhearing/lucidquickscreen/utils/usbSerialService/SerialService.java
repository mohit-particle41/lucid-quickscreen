package com.lucidhearing.lucidquickscreen.utils.usbSerialService;
...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel nc = new NotificationChannel(AppConstant.NOTIFICATION_CHANNEL, "Background service", NotificationManager.IMPORTANCE_LOW);
            nc.setShowBadge(false);
            NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(nc);
        }
        Intent disconnectIntent = new Intent()
                .setAction(AppConstant.INTENT_ACTION_DISCONNECT);
        Intent restartIntent = new Intent()
                .setClassName(this, AppConstant.INTENT_CLASS_MAIN_ACTIVITY)
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, AppConstant.NOTIFICATION_CHANNEL)
                .setSmallIcon(R.drawable.ic_notification)
                .setColor(getResources().getColor(R.color.colorPrimary))
                .setContentTitle(getResources().getString(R.string.app_name))
                .setContentText(socket != null ? "Connected to "+socket.getName() + ": OAE Scanner" : "Background Service")
        ...
        startForeground(AppConstant.NOTIFY_MANAGER_START_FOREGROUND_SERVICE, notification);
    }
